...
export default function NotFound() {
    return (
        <section className="min-h-[calc(100dvh-124px)] h-full w-full flex">
            <div className="border border-indigo-300 rounded-lg flex-1 max-w-[70dvw] min-h-[550px] m-auto">
                ...
                <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
                    ...
                    <div className="block text-center mt-5">
                        ...
                        <Link href="/">
                            <button
                                type="button"
                                className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mt-4"
                            >
                                Go Homepage
                            </button>
                        </Link>
